...
// import Img
import banner from '../../../assets/img/common/img-about.png'
        ...
        <>
            {props.item.mega_menu ? (
                            ...
                            <li className="mega-menu-item">
                                <div className="menu-banner">
                                    <Link to="/shop" className="menu-banner-link">
                                        <img className="menu-banner-img" src={banner} style={{ width: 130 }} alt="img" />
                                    </Link>
                                </div>
                            </li>
                        </ul>
                ...
                <li className="has-dropdown">
                    <a href="#!" id='menuHome' className="main-menu-link">{props.item.name} <i className="fa fa-angle-down"></i></a>
                    <ul className="sub-menu">
                        {props.item.children.map((data, index) => (
                            <li key={index}>
                                <Link id={'item' + index} to={data.href}>{data.name}</Link>
                            </li>
                        ))}
                    </ul>
                </li>
